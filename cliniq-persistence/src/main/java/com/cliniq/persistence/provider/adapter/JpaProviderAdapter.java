package com.cliniq.persistence.provider.adapter;
...
import com.cliniq.persistence.provider.mapper.JpaProviderMapper;
...
public class JpaProviderAdapter implements ProviderRepository {
    ...
    public void save(Provider provider) {
        JpaProviderMapper.toJpa(provider);
        jpaProviderRepository.save(JpaProviderMapper.toJpa(provider));
    }
